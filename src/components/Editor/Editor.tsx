    ...
    const handleResize = () => {
      if (window.innerWidth < 768) {
        ...
        if (window.innerWidth < 578) {
          ...
          if (window.innerWidth < 350) setToolbarHeight("10rem");
        }
      } else {
...
---`;
    ...
    if (from === to) {
      ...
      const transaction = state.update({
        changes: {
          from,
          to,
          insert: `${mark_before}${selectedText}${mark_after}`,
        },
  ...
  const generateComponent = (component_code: string) => {
    ...
    if (from === to) {
      ...
      const transaction = state.update({
        changes: { from, to, insert: `\n\n${component_code}\n\n` },
        selection: {
          anchor: from + component_code.length + 2,
          head: to + component_code.length + 2,
        },
      });
      dispatch(transaction);
    }
                    ...
                    <div className="input-wrapper">
                      <div className="inline-input-wrapper">
                        ...
                        <input
                          ...
                          onBlur={(e) =>
                            checkInputChange(codeRegex, setCode, e)
                          }
                        />
                      </div>
                      <div className="inline-input-wrapper">
                        <label className="input-desc" htmlFor="title">
                          标题：
                        </label>
                        <input
                          id="title"
                      ...
                      <div className="inline-input-wrapper">
                        <label className="input-desc" htmlFor="desc">
                          简介：
                        </label>
                        <input
                          id="desc"
                      ...
                      <div className="inline-input-wrapper">
                        <label className="input-desc" htmlFor="writer">
                          作者：
                        </label>
                        <input
                          id="writer"
                      ...
                      <div className="inline-input-wrapper">
                        <label className="input-desc" htmlFor="firstDate">
                          递交日期：
                        </label>
                        <input
                          id="firstDate"
                      ...
                      <div className="inline-input-wrapper">
                        <label className="input-desc" htmlFor="lastDate">
                          最后更改日期：
                        </label>
                        <input
                          id="lastDate"
              ...
              <div className="tool-icon-wrapper has-inner-list" tabIndex={0}>
                ...
                <ul className="inner-list">
                  ...
                  <li className="generation-input">
                    <div className="input-wrapper">
                      <div className="inline-input-wrapper">
                        <label className="input-desc" htmlFor="table">
                          行数：
                        </label>
                        <input
                          id="tableRow"
                  ...
                  <li className="tool-icon">
                    <button
                      ...
                      title="插入GFM表格"
                      onClick={() =>
                        generateComponent(tableTemplate(tableRow, tableCol))
                      }
                    >
                      <FaTableColumns />
                  ...
                  <li className="tool-icon">
                    <Link
                      className="button"
                      to={`https://www.tablesgenerator.com/html_tables`}
                    >
                      <FaTableList />
              ...
              <div className="tool-icon-wrapper has-inner-list" tabIndex={1}>
                ...
                <ul className="inner-list">
                  ...
                  <div className="input-wrapper">
                    <li className="generation-input">
                      <div className="inline-input-wrapper">
                        <label className="input-desc" htmlFor="codeName">
                          语言：
                        </label>
                        <input
                          type="text"
                          ...
                          placeholder="代码语言"
                          onChange={(e) =>
                            handleInputChange(setCodeLanguage, e)
                          }
                        />
                      </div>
                    </li>
                  ...
                  <li className="tool-icon">
                    <button
                      ...
                      title="区域代码块"
                      onClick={() =>
                        generateComponent(`\`\`\`${codeLanguage}\n\n\`\`\``)
                      }
                    >
                      <IoCodeSlashSharp />
                      <span className="inner-list-item-desc">
                        生成：默认样式
                      </span>
                    </button>
                  </li>
                  <li className="tool-icon">
                    <button
                      className="button example-good"
                      title="区域代码块"
                      onClick={() =>
                        generateComponent("```(language) example-good\n\n```")
                      }
                    >
                      <span className="inner-list-item-desc">
                        生成：良好示例
                  ...
                  <li className="tool-icon">
                    <button
                      className="button example-bad"
                      title="区域代码块"
                      onClick={() =>
                        generateComponent("```(language) example-bad\n\n```")
                      }
                    >
                      <span className="inner-list-item-desc">
                        生成：错误示例
            ...
            <li className="tool-icon">
              <div className="tool-icon-wrapper">
                <button
                  className="button"
                  title="标记块"
                  onClick={() => generateComponent("> [!CALLOUT] \n> \n> ")}
                >
                  <BsChatLeftQuoteFill />
                  <ul className="inner-list">
                    <li className="tool-icon">
                ...
                <ul className="inner-list local-icons">
                  ...
                  <li className="tool-icon">
                    <button
                      ...
                      onClick={() =>
                        generateComponent("> [!WARNING] (title)\n> \n> ")
                      }
                    >
                      <Warning />
                  ...
                  <li className="tool-icon">
                    <button
                      ...
                      onClick={() =>
                        generateComponent("> [!CAUTION] (title)\n> \n> ")
                      }
                    >
                      <Caution />
                  ...
                  <li className="tool-icon">
                    <button
                      ...
                      onClick={() =>
                        generateComponent("> [!EXAMPLE] (title)\n> \n> ")
                      }
                    >
                      <Example />
                  ...
                  <li className="tool-icon">
                    <button
                      ...
                      onClick={() =>
                        generateComponent("> [!IMPORTANT] (title)\n> \n> ")
                      }
                    >
                      <Important />
          ...
          <ul className="user-tool">
            <li className="tool-icon">
              <div className="tool-icon-wrapper">
                <button
                  className="button"
                  onClick={() => downloadMarkdownFile(markdownText)}
                >
                  <MdOutlineSaveAlt />
                  <ul className="inner-list">
                    <li className="tool-icon">
        ...
        <div className="editor-tool-container layout-tools">
          <ul className="content-layout-tool">
            <li className="tool-icon">
              <div className="tool-icon-wrapper">
                <button
                  className={`button ${isMobileMode ? "disabled" : ""}`}
                  onClick={toggleDefaultLayout}
                  disabled={isMobileMode ? true : false}
                >
                  <RiLayoutColumnLine />
                  <ul className="inner-list">
                    <li className="tool-icon">
  ...
  return (
    <Suspense fallback={<Loading />}>
      {isFullscreen
        ? ReactDOM.createPortal(createWrapper(editorContent), document.body)
        : editorContent}
    </Suspense>
  );
};
